...
pub struct ClientSideWeightedRoundRobin {
    ...
    pub enable_oob_load_report: ::core::option::Option<bool>,
    /// Load reporting interval to request from the server. Note that the
    /// server may not provide reports as frequently as the client requests.
    /// Used only when enable_oob_load_report is true. Default is 10 seconds.
    #[prost(message, optional, tag = "2")]
    pub oob_reporting_period: ::core::option::Option<::prost_types::Duration>,
    ...
    pub blackout_period: ::core::option::Option<::prost_types::Duration>,
    ...
    pub weight_expiration_period: ::core::option::Option<::prost_types::Duration>,
    /// How often endpoint weights are recalculated. Values less than 100ms are
    /// capped at 100ms. Default is 1 second.
    #[prost(message, optional, tag = "5")]
    pub weight_update_period: ::core::option::Option<::prost_types::Duration>,

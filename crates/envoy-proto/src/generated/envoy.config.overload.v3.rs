...
pub struct ScaleTimersOverloadActionConfig {
    ...
    pub timer_scale_factors:
        ::prost::alloc::vec::Vec<scale_timers_overload_action_config::ScaleTimer>,
}
...
pub mod scale_timers_overload_action_config {
    ...
    pub mod scale_timer {
        ...
        pub enum OverloadAdjust {
            ...
            #[prost(message, tag = "2")]
            MinTimeout(::prost_types::Duration),
    ...
    impl TimerType {
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "HTTP_DOWNSTREAM_CONNECTION_IDLE" => Some(Self::HttpDownstreamConnectionIdle),
                "HTTP_DOWNSTREAM_STREAM_IDLE" => Some(Self::HttpDownstreamStreamIdle),
                "TRANSPORT_SOCKET_CONNECT" => Some(Self::TransportSocketConnect),
                "HTTP_DOWNSTREAM_CONNECTION_MAX" => Some(Self::HttpDownstreamConnectionMax),
...
pub struct ShrinkHeapConfig {
    ...
    pub timer_interval: ::core::option::Option<::prost_types::Duration>,
    ...
    pub max_unfreed_memory_bytes: ::core::option::Option<u64>,
}
#[derive(Clone, PartialEq, ::prost::Message)]

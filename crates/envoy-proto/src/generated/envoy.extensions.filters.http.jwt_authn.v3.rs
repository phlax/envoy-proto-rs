...
pub struct JwtProvider {
    ...
    pub normalize_payload_in_metadata: ::core::option::Option<jwt_provider::NormalizePayload>,
...
pub mod jwt_provider {
    ...
    pub struct NormalizePayload {
        ...
        pub space_delimited_claims: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
    }
    /// `JSON Web Key Set (JWKS) <<https://tools.ietf.org/html/rfc7517#appendix-A>`\_> is needed to
    /// validate signature of a JWT. This field specifies where to fetch JWKS.
...
pub struct JwksAsyncFetch {
    ...
    #[prost(message, optional, tag = "2")]
    pub failed_refetch_duration: ::core::option::Option<::prost_types::Duration>,
}
...
pub struct RequirementRule {
    ...
    #[prost(message, optional, tag = "1")]
    pub r#match:
        ::core::option::Option<super::super::super::super::super::config::route::v3::RouteMatch>,
...
pub struct JwtAuthentication {
    ...
    pub requirement_map:
        ::std::collections::HashMap<::prost::alloc::string::String, JwtRequirement>,

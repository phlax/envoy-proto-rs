...
pub mod http_buffered_trace {
    ...
    pub struct Message {
        ...
        pub headers:
            ::prost::alloc::vec::Vec<super::super::super::super::config::core::v3::HeaderValue>,
        /// Message body.
        #[prost(message, optional, tag = "2")]
        ...
        #[prost(message, optional, tag = "4")]
        pub headers_received_time: ::core::option::Option<::prost_types::Timestamp>,
    }
}
...
pub struct SocketStreamedTraceSegment {
    ...
    pub trace_id: u64,
    #[prost(
        oneof = "socket_streamed_trace_segment::MessagePiece",
        tags = "2, 3, 4"
    )]

...
pub struct ExtAuthz {
    ...
    pub route_metadata_context_namespaces: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
    ///
    /// Specifies a list of route metadata namespaces whose values, if present, will be passed to the
    /// ext_authz service at :ref:`route_metadata_context <envoy_v3_api_field_service.auth.v3.AttributeContext.route_metadata_context>` in
    /// : ref:`CheckRequest <envoy_v3_api_field_service.auth.v3.CheckRequest.attributes>`.
    ...
    pub route_typed_metadata_context_namespaces:
    ...
    pub charge_cluster_response_stats: ::core::option::Option<bool>,
    ...
    pub enable_dynamic_metadata_ingestion: ::core::option::Option<bool>,
    ...
    /// : ref:`ShadowDecision  <envoy_v3_api_msg_extensions.filters.http.ext_authz.v3.ShadowDecision>` object so
...
/// when :ref:`shadow_mode  <envoy_v3_api_field_extensions.filters.http.ext_authz.v3.ExtAuthz.shadow_mode>` is
/// enabled. Consumed by a downstream filter that decides whether to enforce the
/// decision.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ShadowDecision {
    /// The decision the auth server returned.
    #[prost(enumeration = "shadow_decision::CheckResult", tag = "1")]
    ...
    /// or :ref:`status_on_error  <envoy_v3_api_field_extensions.filters.http.ext_authz.v3.ExtAuthz.status_on_error>` fallback
...
/// Nested message and enum types in `ShadowDecision`.
...
pub struct HttpService {
    ...
    pub server_uri:
        ::core::option::Option<super::super::super::super::super::config::core::v3::HttpUri>,
    ...
    /// Only one of `path_prefix` or `path_override` may be set.
    #[prost(string, tag = "10")]
    pub path_override: ::prost::alloc::string::String,
    ...
    #[prost(message, optional, tag = "9")]
    pub retry_policy:
        ::core::option::Option<super::super::super::super::super::config::core::v3::RetryPolicy>,
}
#[derive(Clone, PartialEq, ::prost::Message)]

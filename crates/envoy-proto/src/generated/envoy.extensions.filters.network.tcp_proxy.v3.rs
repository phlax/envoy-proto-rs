...
pub struct TcpProxy {
    ...
    pub downstream_idle_timeout: ::core::option::Option<::prost_types::Duration>,
    /// \[\#not-implemented-hide:\]
    #[prost(message, optional, tag = "4")]
    pub upstream_idle_timeout: ::core::option::Option<::prost_types::Duration>,
    ...
    pub max_connect_attempts: ::core::option::Option<u32>,
    ...
    pub hash_policy:
        ::prost::alloc::vec::Vec<super::super::super::super::super::r#type::v3::HashPolicy>,
    ...
    pub max_downstream_connection_duration: ::core::option::Option<::prost_types::Duration>,
    ...
    pub max_downstream_connection_duration_jitter_percentage:
        ::core::option::Option<super::super::super::super::super::r#type::v3::Percent>,
    /// If both this field and :ref:`access_log_flush_interval  <envoy_v3_api_field_extensions.filters.network.tcp_proxy.v3.TcpProxy.TcpAccessLogOptions.access_log_flush_interval>`
    ...
    pub access_log_flush_interval: ::core::option::Option<::prost_types::Duration>,
    /// If both this field and :ref:`flush_access_log_on_connected  <envoy_v3_api_field_extensions.filters.network.tcp_proxy.v3.TcpProxy.TcpAccessLogOptions.flush_access_log_on_connected>`
    /// are specified, the former (deprecated field) is ignored.
    ///
    ///
    /// .. attention::
    ...
    /// proxy protocol transport. See :ref:`core.v3.ProxyProtocolConfig.pass_through_tlvs    <envoy_v3_api_field_config.core.v3.ProxyProtocolConfig.pass_through_tlvs>` for details.
    #[prost(message, repeated, tag = "19")]
    pub proxy_protocol_tlvs:
        ::prost::alloc::vec::Vec<super::super::super::super::super::config::core::v3::TlvEntry>,
    ///
    ...
    /// : ref:`ProxyProtocolTlvMergePolicy  <envoy_v3_api_enum_extensions.filters.network.tcp_proxy.v3.ProxyProtocolTlvMergePolicy>`.
    #[prost(enumeration = "ProxyProtocolTlvMergePolicy", tag = "23")]
    pub proxy_protocol_tlv_merge_policy: i32,
    ...
    #[prost(enumeration = "UpstreamConnectMode", tag = "21")]
    pub upstream_connect_mode: i32,
    ...
    pub max_early_data_bytes: ::core::option::Option<u32>,
...
pub mod tcp_proxy {
    ...
    pub struct TunnelingConfig {
        ...
        #[prost(message, optional, tag = "7")]
        pub request_id_extension: ::core::option::Option<
            super::super::super::http_connection_manager::v3::RequestIdExtension,
        >,
        ...
        #[prost(string, tag = "8")]
        pub request_id_header: ::prost::alloc::string::String,
        ...
        #[prost(string, tag = "9")]
        pub request_id_metadata_key: ::prost::alloc::string::String,
    }
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct OnDemand {
...
pub enum UpstreamConnectMode {
    ...
    OnDownstreamTlsHandshake = 2,
}
impl UpstreamConnectMode {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::OnDownstreamData => "ON_DOWNSTREAM_DATA",
            Self::OnDownstreamTlsHandshake => "ON_DOWNSTREAM_TLS_HANDSHAKE",
        }
    }
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "ON_DOWNSTREAM_DATA" => Some(Self::OnDownstreamData),
            "ON_DOWNSTREAM_TLS_HANDSHAKE" => Some(Self::OnDownstreamTlsHandshake),
            _ => None,
        }
    }
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
#[repr(i32)]
pub enum ProxyProtocolTlvMergePolicy {
    ...
    OverwriteByTypeIfExistsOrAdd = 1,
    ...
    /// If no state exists, add all configured TLVs.
    /// Source/destination addresses from existing state are preserved.
    AppendIfExistsOrAdd = 2,
}
impl ProxyProtocolTlvMergePolicy {
    /// String value of the enum field names used in the ProtoBuf definition.
    ///
    /// The values are not transformed in any way and thus are considered stable
    /// (if the ProtoBuf definition does not change) and safe for programmatic use.
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::OverwriteByTypeIfExistsOrAdd => "OVERWRITE_BY_TYPE_IF_EXISTS_OR_ADD",
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "OVERWRITE_BY_TYPE_IF_EXISTS_OR_ADD" => Some(Self::OverwriteByTypeIfExistsOrAdd),

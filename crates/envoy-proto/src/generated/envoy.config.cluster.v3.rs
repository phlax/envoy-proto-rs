...
pub struct Filter {
    ...
    /// Only one of typed_config or config_discovery can be used.
    #[prost(message, optional, tag = "3")]
    pub config_discovery: ::core::option::Option<super::super::core::v3::ExtensionConfigSource>,
}
...
pub struct OutlierDetection {
    ...
    pub successful_active_health_check_uneject_host: ::core::option::Option<bool>,
    ...
    pub always_eject_one_host: ::core::option::Option<bool>,
    ...
    pub detect_degraded_hosts: ::core::option::Option<bool>,
}
...
pub struct Cluster {
    ...
    pub transport_socket_matcher:
        ::core::option::Option<super::super::super::super::xds::r#type::matcher::v3::Matcher>,
    ...
    pub per_connection_buffer_high_watermark_timeout:
    ...
    pub upstream_http_protocol_options:
        ::core::option::Option<super::super::core::v3::UpstreamHttpProtocolOptions>,
    ...
    pub common_http_protocol_options:
        ::core::option::Option<super::super::core::v3::HttpProtocolOptions>,
    ...
    pub http2_protocol_options:
        ::core::option::Option<super::super::core::v3::Http2ProtocolOptions>,
    ...
    pub dns_jitter: ::core::option::Option<::prost_types::Duration>,
    ...
    pub typed_dns_resolver_config:
        ::core::option::Option<super::super::core::v3::TypedExtensionConfig>,
    ...
    pub lrs_report_endpoint_metrics: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
...
pub mod cluster {
    ...
    pub struct TransportSocketMatch {
        ...
        #[prost(message, optional, tag = "3")]
        pub transport_socket:
            ::core::option::Option<super::super::super::core::v3::TransportSocket>,
    }
    ...
    pub struct SlowStartConfig {
        ...
        #[prost(message, optional, tag = "3")]
        pub min_weight_percent:
            ::core::option::Option<super::super::super::super::r#type::v3::Percent>,
    }
    ...
    pub struct LeastRequestLbConfig {
        ...
        pub active_request_bias:
            ::core::option::Option<super::super::super::core::v3::RuntimeDouble>,
        /// Configuration for slow start mode.
        /// If this configuration is not set, slow start will not be not enabled.
        #[prost(message, optional, tag = "3")]
        pub slow_start_config: ::core::option::Option<SlowStartConfig>,
    ...
    pub struct OriginalDstLbConfig {
        ...
        #[prost(message, optional, tag = "3")]
        pub upstream_port_override: ::core::option::Option<u32>,
        /// The dynamic metadata key to override destination address.
        /// First the request metadata is considered, then the connection one.
        #[prost(message, optional, tag = "4")]
        pub metadata_key:
            ::core::option::Option<super::super::super::super::r#type::metadata::v3::MetadataKey>,
    }
    /// Common configuration for all load balancer implementations.
    /// \[#next-free-field: 9\]
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct CommonLbConfig {
        ...
        pub consistent_hashing_lb_config:
            ::core::option::Option<common_lb_config::ConsistentHashingLbConfig>,
        ...
        #[prost(message, optional, tag = "8")]
        pub override_host_status:
            ::core::option::Option<super::super::super::core::v3::HealthStatusSet>,
        #[prost(oneof = "common_lb_config::LocalityConfigSpecifier", tags = "2, 3")]
        pub locality_config_specifier:
            ::core::option::Option<common_lb_config::LocalityConfigSpecifier>,
    }
...
pub mod load_balancing_policy {
    ...
    pub struct Policy {
        ...
        #[prost(message, optional, tag = "4")]
        pub typed_extension_config:
            ::core::option::Option<super::super::super::core::v3::TypedExtensionConfig>,
    }
}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct UpstreamConnectionOptions {
    ...
    #[prost(message, optional, tag = "3")]
    pub happy_eyeballs_config:
        ::core::option::Option<upstream_connection_options::HappyEyeballsConfig>,
}
...
pub mod upstream_connection_options {
    ...
    pub struct HappyEyeballsConfig {
        ...
        #[prost(message, optional, tag = "2")]
        pub first_address_family_count: ::core::option::Option<u32>,
    }

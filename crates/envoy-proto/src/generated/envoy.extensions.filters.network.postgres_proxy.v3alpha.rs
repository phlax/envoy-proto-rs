...
pub struct PostgresProxy {
    ...
    /// session. In order to do that, the filter chain must use :ref:`starttls transport socket  <envoy_v3_api_msg_extensions.transport_sockets.starttls.v3.StartTlsConfig>`.

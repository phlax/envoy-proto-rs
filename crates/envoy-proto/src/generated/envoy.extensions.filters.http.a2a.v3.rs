    ...
    impl StorageMode {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::DynamicMetadataAndFilterState => "DYNAMIC_METADATA_AND_FILTER_STATE",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "DYNAMIC_METADATA_AND_FILTER_STATE" => Some(Self::DynamicMetadataAndFilterState),
                _ => None,
            }
        }
    }
...
pub struct ParserConfig {
    ...
    pub method_configs:
        ::std::collections::HashMap<::prost::alloc::string::String, MethodParsingConfig>,
    /// Attributes that should always be extracted regardless of the method.
    /// Specified by their JSON paths (e.g., "params.id").
    #[prost(string, repeated, tag = "2")]
    pub always_extract_attributes: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,

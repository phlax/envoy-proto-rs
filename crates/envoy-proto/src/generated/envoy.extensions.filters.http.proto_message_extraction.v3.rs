...
pub struct ProtoMessageExtractionConfig {
    #[prost(
        enumeration = "proto_message_extraction_config::ExtractMode",
        tag = "3"
    )]
    pub mode: i32,
    ...
    pub extraction_by_method:
        ::std::collections::HashMap<::prost::alloc::string::String, MethodExtraction>,
    /// The proto descriptor set binary for the gRPC services.
    #[prost(
        oneof = "proto_message_extraction_config::DescriptorSet",
        tags = "1, 2"
    )]
    pub descriptor_set: ::core::option::Option<proto_message_extraction_config::DescriptorSet>,
}
...
pub struct MethodExtraction {
    ...
    #[prost(
        map = "string, enumeration(method_extraction::ExtractDirective)",
        tag = "2"
    )]
    pub request_extraction_by_field:
    ...
    pub response_extraction_by_field:
        ::std::collections::HashMap<::prost::alloc::string::String, i32>,
}

...
pub mod rbac {
    ...
    pub struct AuditLoggingOptions {
        ...
        pub logger_configs: ::prost::alloc::vec::Vec<audit_logging_options::AuditLoggerConfig>,
    }
...
pub struct Policy {
    ...
    #[prost(message, optional, tag = "3")]
    pub condition:
        ::core::option::Option<super::super::super::super::google::api::expr::v1alpha1::Expr>,
    /// \[\#not-implemented-hide:\]
...
pub struct SourcedMetadata {
    ...
    #[prost(message, optional, tag = "1")]
    pub metadata_matcher:
        ::core::option::Option<super::super::super::r#type::matcher::v3::MetadataMatcher>,

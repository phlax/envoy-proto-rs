...
pub struct CommonGeoipProviderConfig {
    ...
    pub geo_headers_to_add:
        ::core::option::Option<common_geoip_provider_config::GeolocationHeadersToAdd>,
    /// Configuration for geolocation field keys.
    /// At least one of `geo_headers_to_add` or `geo_field_keys` must be set.
    #[prost(message, optional, tag = "3")]
    pub geo_field_keys: ::core::option::Option<common_geoip_provider_config::GeolocationFieldKeys>,
}

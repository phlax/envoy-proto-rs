...
pub struct HttpConnectionManager {
    ...
    pub add_user_agent: ::core::option::Option<bool>,
    ...
    pub max_request_headers_kb: ::core::option::Option<u32>,
    ...
    pub stream_idle_timeout: ::core::option::Option<::prost_types::Duration>,
    ...
    pub stream_flush_timeout: ::core::option::Option<::prost_types::Duration>,
    ...
    pub request_headers_timeout: ::core::option::Option<::prost_types::Duration>,
    ...
    pub delayed_close_timeout: ::core::option::Option<::prost_types::Duration>,
    ...
    pub access_log_options: ::core::option::Option<http_connection_manager::HcmAccessLogOptions>,
    ///
    ...
    pub internal_address_config:
        ::core::option::Option<http_connection_manager::InternalAddressConfig>,
    ///
    ...
    pub generate_request_id: ::core::option::Option<bool>,
    ...
    pub set_current_client_cert_details:
        ::core::option::Option<http_connection_manager::SetCurrentClientCertDetails>,
    ///
    ...
    pub forward_client_cert_matcher: ::core::option::Option<
    ...
    pub normalize_path: ::core::option::Option<bool>,
    ///
    ...
    pub stream_error_on_invalid_http_message: ::core::option::Option<bool>,
    ...
    pub path_normalization_options:
        ::core::option::Option<http_connection_manager::PathNormalizationOptions>,
    ...
    pub add_proxy_protocol_connection_state: ::core::option::Option<bool>,
    ...
    pub forward_proto_config: ::core::option::Option<ForwardProtoConfig>,
...
pub mod http_connection_manager {
    ...
    pub struct Tracing {
        ...
        pub client_sampling:
            ::core::option::Option<super::super::super::super::super::super::r#type::v3::Percent>,
        ///
        ...
        pub spawn_upstream_span: ::core::option::Option<bool>,
        ...
        #[prost(bool, tag = "13")]
        pub no_context_propagation: bool,
    }
    ...
    pub struct SetCurrentClientCertDetails {
        ...
        pub subject: ::core::option::Option<bool>,
        ...
        #[prost(bool, tag = "5")]
        pub uri: bool,
        /// The format for the header. When the :ref:`forward_client_cert_details  <envoy_v3_api_field_extensions.filters.network.http_connection_manager.v3.HttpConnectionManager.forward_client_cert_details>`
        ...
        #[prost(enumeration = "ForwardClientCertFormat", tag = "7")]
        pub format: i32,
    }
    ///
    /// The configuration for forwarding client cert details, used as the action config in a
    /// : ref:`forward_client_cert_matcher  <envoy_v3_api_field_extensions.filters.network.http_connection_manager.v3.HttpConnectionManager.forward_client_cert_matcher>`.
    #[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
    pub struct ForwardClientCertConfig {
        /// How to handle the XFCC header.
        #[prost(enumeration = "ForwardClientCertDetails", tag = "1")]
        pub forward_client_cert_details: i32,
        ///
        ...
        pub set_current_client_cert_details: ::core::option::Option<SetCurrentClientCertDetails>,
    }
    ...
    impl PathWithEscapedSlashesAction {
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "IMPLEMENTATION_SPECIFIC_DEFAULT" => Some(Self::ImplementationSpecificDefault),
    ...
    #[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
    #[repr(i32)]
    pub enum ForwardClientCertFormat {
...
pub struct ForwardProtoConfig {
    ...
    pub https_destination_ports: ::prost::alloc::vec::Vec<u32>,
    ...
    pub http_destination_ports: ::prost::alloc::vec::Vec<u32>,
}

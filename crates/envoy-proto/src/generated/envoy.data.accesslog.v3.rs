...
pub struct AccessLogCommon {
    ...
    pub time_to_last_rx_byte: ::core::option::Option<::prost_types::Duration>,
    ...
    pub time_to_first_upstream_tx_byte: ::core::option::Option<::prost_types::Duration>,
    /// Interval between the first downstream byte received and the last upstream byte sent. There may
    /// by considerable delta between `time_to_last_rx_byte` and this value due to filters.
    /// Additionally, the same caveats apply as documented in `time_to_last_downstream_tx_byte` about
    /// not accounting for kernel socket buffer time, etc.
    #[prost(message, optional, tag = "8")]
    pub time_to_last_upstream_tx_byte: ::core::option::Option<::prost_types::Duration>,
    /// Interval between the first downstream byte received and the first upstream
    /// byte received (i.e. time it takes to start receiving a response).
    #[prost(message, optional, tag = "9")]
    pub time_to_first_upstream_rx_byte: ::core::option::Option<::prost_types::Duration>,
    /// Interval between the first downstream byte received and the last upstream
    /// byte received (i.e. time it takes to receive a complete response).
    #[prost(message, optional, tag = "10")]
    pub time_to_last_upstream_rx_byte: ::core::option::Option<::prost_types::Duration>,
    /// Interval between the first downstream byte received and the first downstream byte sent.
    /// There may be a considerable delta between the `time_to_first_upstream_rx_byte` and this field
    /// due to filters. Additionally, the same caveats apply as documented in
    /// `time_to_last_downstream_tx_byte` about not accounting for kernel socket buffer time, etc.
    #[prost(message, optional, tag = "11")]
    pub time_to_first_downstream_tx_byte: ::core::option::Option<::prost_types::Duration>,
    ...
    pub time_to_last_downstream_tx_byte: ::core::option::Option<::prost_types::Duration>,
    /// The upstream remote/destination address that handles this exchange. This does not include
    /// retries.
    #[prost(message, optional, tag = "13")]
    pub upstream_remote_address:
        ::core::option::Option<super::super::super::config::core::v3::Address>,
    /// The upstream local/origin address that handles this exchange. This does not include retries.
    #[prost(message, optional, tag = "14")]
    pub upstream_local_address:
        ::core::option::Option<super::super::super::config::core::v3::Address>,
...
pub struct TlsProperties {
    ...
    #[prost(message, optional, tag = "2")]
    pub tls_cipher_suite: ::core::option::Option<u32>,

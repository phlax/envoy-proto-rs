...
pub struct AdmissionControl {
    ...
    pub sampling_window: ::core::option::Option<::prost_types::Duration>,
    ...
    pub aggression:
        ::core::option::Option<super::super::super::super::super::config::core::v3::RuntimeDouble>,
    ...
    pub sr_threshold:
        ::core::option::Option<super::super::super::super::super::config::core::v3::RuntimePercent>,
    ...
    pub rps_threshold:
        ::core::option::Option<super::super::super::super::super::config::core::v3::RuntimeUInt32>,
    /// The probability of rejection will never exceed this value, even if the failure rate is rising.
    /// Defaults to 80%.
    #[prost(message, optional, tag = "7")]
    pub max_rejection_probability:
        ::core::option::Option<super::super::super::super::super::config::core::v3::RuntimePercent>,

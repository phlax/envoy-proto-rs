...
pub struct SaveProcessingResponse {
    ...
    pub save_request_headers: ::core::option::Option<save_processing_response::SaveOptions>,
    /// Save the response to filter state when
    /// :ref:`response_headers <envoy_v3_api_field_service.ext_proc.v3.ProcessingResponse.response_headers>`
    /// is set.
    #[prost(message, optional, tag = "3")]
    pub save_response_headers: ::core::option::Option<save_processing_response::SaveOptions>,
    /// Save the response to filter state when
    /// :ref:`request_trailers <envoy_v3_api_field_service.ext_proc.v3.ProcessingResponse.request_trailers>`
    /// is set.
    #[prost(message, optional, tag = "4")]
    pub save_request_trailers: ::core::option::Option<save_processing_response::SaveOptions>,
    /// Save the response to filter state when
    /// :ref:`response_trailers <envoy_v3_api_field_service.ext_proc.v3.ProcessingResponse.response_trailers>`
    /// is set.
    #[prost(message, optional, tag = "5")]
    pub save_response_trailers: ::core::option::Option<save_processing_response::SaveOptions>,
    /// Save the response to filter state when
    /// :ref:`immediate_response <envoy_v3_api_field_service.ext_proc.v3.ProcessingResponse.immediate_response>`
    /// is set.
    #[prost(message, optional, tag = "6")]
    pub save_immediate_response: ::core::option::Option<save_processing_response::SaveOptions>,
}

...
pub struct SinkConfig {
    ...
    pub emit_tags_as_attributes: ::core::option::Option<bool>,
    ...
    pub use_tag_extracted_name: ::core::option::Option<bool>,
    ...
    >,
    #[prost(oneof = "sink_config::ProtocolSpecifier", tags = "1, 9")]
...
pub mod sink_config {
    ...
    pub enum ProtocolSpecifier {
        ...
        #[prost(message, tag = "9")]
        HttpService(super::super::super::super::super::config::core::v3::HttpService),
    }
}

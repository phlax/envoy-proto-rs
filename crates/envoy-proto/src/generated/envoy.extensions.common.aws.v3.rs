...
pub struct AwsCredentialProvider {
    ...
    pub assume_role_with_web_identity_provider:
        ::core::option::Option<AssumeRoleWithWebIdentityCredentialProvider>,
    ...
    pub credentials_file_provider: ::core::option::Option<CredentialsFileCredentialProvider>,
    ...
    pub iam_roles_anywhere_credential_provider:
        ::core::option::Option<IamRolesAnywhereCredentialProvider>,
    ...
    pub container_credential_provider: ::core::option::Option<ContainerCredentialProvider>,
    ...
    pub environment_credential_provider: ::core::option::Option<EnvironmentCredentialProvider>,
    ...
    pub instance_profile_credential_provider:
        ::core::option::Option<InstanceProfileCredentialProvider>,
    ...
    pub assume_role_credential_provider:
        ::core::option::Option<::prost::alloc::boxed::Box<AssumeRoleCredentialProvider>>,
}
...
pub struct AssumeRoleWithWebIdentityCredentialProvider {
    ...
    #[prost(message, optional, tag = "1")]
    pub web_identity_token_data_source:
...
pub struct AssumeRoleCredentialProvider {
    ...
    pub credential_provider:
        ::core::option::Option<::prost::alloc::boxed::Box<AwsCredentialProvider>>,
}

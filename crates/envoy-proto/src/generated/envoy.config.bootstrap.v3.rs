...
pub struct Bootstrap {
    ...
    pub stats_flush_interval: ::core::option::Option<::prost_types::Duration>,
    ...
    pub stats_server_version_override: ::core::option::Option<u64>,
    ///
    ...
    pub xds_config_tracker_extension:
        ::core::option::Option<super::super::core::v3::TypedExtensionConfig>,
    /// \[\#not-implemented-hide:\]
    ...
    pub grpc_async_client_manager_config:
        ::core::option::Option<bootstrap::GrpcAsyncClientManagerConfig>,
    ...
    #[prost(oneof = "bootstrap::StatsEviction", tags = "42")]
    pub stats_eviction: ::core::option::Option<bootstrap::StatsEviction>,
}
...
pub mod bootstrap {
    ...
    pub struct GrpcAsyncClientManagerConfig {
        ...
        #[prost(message, optional, tag = "1")]
        pub max_cached_entry_idle_duration: ::core::option::Option<::prost_types::Duration>,
    }
    ...
    pub enum StatsEviction {
        ...
        StatsEvictionInterval(::prost_types::Duration),
    }
}
...
pub mod cluster_manager {
    ...
    pub struct OutlierDetection {
        ...
        #[prost(message, optional, tag = "2")]
        pub event_service:
            ::core::option::Option<super::super::super::core::v3::EventServiceConfig>,
    }
}
...
pub struct Watchdog {
    ...
    #[prost(message, optional, tag = "1")]
    pub miss_timeout: ::core::option::Option<::prost_types::Duration>,
    /// The duration after which Envoy counts a nonresponsive thread in the
    /// `watchdog_mega_miss` statistic. If not specified the default is `1000ms`.
    #[prost(message, optional, tag = "2")]
    pub megamiss_timeout: ::core::option::Option<::prost_types::Duration>,
    /// If a watched thread has been nonresponsive for this duration, assume a
    /// programming error and kill the entire Envoy process. Set to `0` to disable
    /// kill behavior. If not specified the default is `0` (disabled).
    #[prost(message, optional, tag = "3")]
    pub kill_timeout: ::core::option::Option<::prost_types::Duration>,
    /// Defines the maximum jitter used to adjust the `kill_timeout` if `kill_timeout` is
    /// enabled. Enabling this feature would help to reduce risk of synchronized
    /// watchdog kill events across proxies due to external triggers. Set to `0` to
    /// disable. If not specified the default is `0` (disabled).
    #[prost(message, optional, tag = "6")]
    pub max_kill_timeout_jitter: ::core::option::Option<::prost_types::Duration>,
    /// If `max(2, ceil(registered_threads * Fraction(multikill_threshold)))`
    /// threads have been nonresponsive for at least this duration kill the entire
    /// Envoy process. Set to `0` to disable this behavior. If not specified the
    /// default is `0` (disabled).
    #[prost(message, optional, tag = "4")]
    pub multikill_timeout: ::core::option::Option<::prost_types::Duration>,
...
pub struct Runtime {
    ...
    #[prost(message, optional, tag = "4")]
    pub base: ::core::option::Option<::prost_types::Struct>,
}
/// \[\#next-free-field: 6\]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub mod runtime_layer {
    ...
    pub enum LayerSpecifier {
        ...
        #[prost(message, tag = "2")]
        StaticLayer(::prost_types::Struct),
        #[prost(message, tag = "3")]
        DiskLayer(DiskLayer),
        #[prost(message, tag = "4")]
...
pub struct MemoryAllocatorManager {
    ...
    #[prost(message, optional, tag = "2")]
    pub memory_release_interval: ::core::option::Option<::prost_types::Duration>,
    ...
    #[prost(message, optional, tag = "3")]
    pub soft_memory_limit_bytes: ::core::option::Option<u64>,
    ...
    /// This is currently only supported with tcmalloc and not with `gperftools`.
    #[prost(message, optional, tag = "4")]
    pub max_per_cpu_cache_size_bytes: ::core::option::Option<u32>,
    ...
    #[prost(uint64, tag = "5")]
    pub max_unfreed_memory_bytes: u64,
}

...
pub struct RateLimitQuotaBucketSettings {
    ...
    pub bucket_id_builder:
        ::core::option::Option<rate_limit_quota_bucket_settings::BucketIdBuilder>,
    ...
    pub no_assignment_behavior:
        ::core::option::Option<rate_limit_quota_bucket_settings::NoAssignmentBehavior>,
...
pub mod rate_limit_quota_bucket_settings {
    ...
    pub struct NoAssignmentBehavior {
        ...
        pub no_assignment_behavior:
            ::core::option::Option<no_assignment_behavior::NoAssignmentBehavior>,
    }
    ...
    pub struct ExpiredAssignmentBehavior {
        ...
        #[prost(message, optional, tag = "1")]
        pub expired_assignment_behavior_timeout: ::core::option::Option<::prost_types::Duration>,
        #[prost(
            oneof = "expired_assignment_behavior::ExpiredAssignmentBehavior",
            tags = "2, 3"
        )]
        pub expired_assignment_behavior:
            ::core::option::Option<expired_assignment_behavior::ExpiredAssignmentBehavior>,
    }

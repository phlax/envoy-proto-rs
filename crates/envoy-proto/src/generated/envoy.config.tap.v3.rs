...
pub struct OutputConfig {
    ...
    /// default is 1KiB.
    #[prost(message, optional, tag = "2")]
    pub max_buffered_rx_bytes: ::core::option::Option<u32>,
    /// For buffered tapping, the maximum amount of transmitted body that will be buffered prior to
    /// truncation. If truncation occurs, the :ref:`truncated
    /// <envoy_v3_api_field_data.tap.v3.Body.truncated>` field will be set. If not specified, the
    /// default is 1KiB.
    #[prost(message, optional, tag = "3")]
    pub max_buffered_tx_bytes: ::core::option::Option<u32>,
    ...
    pub min_streamed_sent_bytes: ::core::option::Option<u32>,
}

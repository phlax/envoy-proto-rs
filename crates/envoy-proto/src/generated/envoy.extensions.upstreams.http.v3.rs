...
pub struct HttpProtocolOptions {
    ...
    pub common_http_protocol_options:
        ::core::option::Option<super::super::super::super::config::core::v3::HttpProtocolOptions>,
    ...
    pub outlier_detection: ::core::option::Option<http_protocol_options::OutlierDetection>,
    ...
    pub retry_policy:
        ::core::option::Option<super::super::super::super::config::route::v3::RetryPolicy>,
    /// This controls the actual protocol to be used upstream.
    #[prost(
        oneof = "http_protocol_options::UpstreamProtocolOptions",
        tags = "3, 4, 5"
    )]
    pub upstream_protocol_options:
        ::core::option::Option<http_protocol_options::UpstreamProtocolOptions>,
}

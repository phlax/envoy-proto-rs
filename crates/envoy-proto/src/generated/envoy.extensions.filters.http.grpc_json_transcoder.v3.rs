...
pub struct GrpcJsonTranscoder {
    ...
    pub request_validation_options:
        ::core::option::Option<grpc_json_transcoder::RequestValidationOptions>,
    ...
    pub max_request_body_size: ::core::option::Option<u32>,
    ...
    pub max_response_body_size: ::core::option::Option<u32>,
...
pub mod grpc_json_transcoder {
    ...
    impl UrlUnescapeSpec {
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "ALL_CHARACTERS_EXCEPT_RESERVED" => Some(Self::AllCharactersExceptReserved),
...
pub struct UnknownQueryParams {
    ...
    pub key:
        ::std::collections::HashMap<::prost::alloc::string::String, unknown_query_params::Values>,
}

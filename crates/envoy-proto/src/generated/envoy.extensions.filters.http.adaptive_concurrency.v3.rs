...
pub struct GradientControllerConfig {
    ...
    pub sample_aggregate_percentile:
        ::core::option::Option<super::super::super::super::super::r#type::v3::Percent>,
    #[prost(message, optional, tag = "2")]
    pub concurrency_limit_params:
        ::core::option::Option<gradient_controller_config::ConcurrencyLimitCalculationParams>,
    #[prost(message, optional, tag = "3")]
    pub min_rtt_calc_params:
        ::core::option::Option<gradient_controller_config::MinimumRttCalculationParams>,
}
...
pub mod gradient_controller_config {
    ...
    pub struct ConcurrencyLimitCalculationParams {
        ...
        #[prost(message, optional, tag = "2")]
        pub max_concurrency_limit: ::core::option::Option<u32>,
    ...
    pub struct MinimumRttCalculationParams {
        ...
        pub fixed_value: ::core::option::Option<::prost_types::Duration>,
        /// The number of requests to aggregate/sample during the minRTT recalculation window before
        /// updating. Defaults to 50.
        #[prost(message, optional, tag = "2")]
        pub request_count: ::core::option::Option<u32>,
        ...
        pub min_concurrency: ::core::option::Option<u32>,
...
pub struct AdaptiveConcurrency {
    ...
    #[prost(
        oneof = "adaptive_concurrency::ConcurrencyControllerConfig",
        tags = "1"
    )]
    pub concurrency_controller_config:
        ::core::option::Option<adaptive_concurrency::ConcurrencyControllerConfig>,
}

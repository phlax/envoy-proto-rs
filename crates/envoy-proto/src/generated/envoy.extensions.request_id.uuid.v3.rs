...
///
/// 1. Tracing decision (sampled, forced, etc) is set in 13th nibble of the UUID. By default this will
...
pub struct UuidRequestIdConfig {
    ...
    pub pack_trace_reason: ::core::option::Option<bool>,
    ...
    pub use_request_id_for_trace_sampling: ::core::option::Option<bool>,
}

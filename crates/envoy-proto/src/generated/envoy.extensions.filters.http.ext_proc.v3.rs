...
pub struct ExternalProcessor {
    ...
    pub grpc_service:
        ::core::option::Option<super::super::super::super::super::config::core::v3::GrpcService>,
    ///
    ...
    ///    :ref:`ProcessingRequest <envoy_v3_api_msg_service.ext_proc.v3.ProcessingRequest>`.
    ///
    /// 1. This proto message is then transcoded into a JSON text.
    ///
    /// 1. The data plane then sends an HTTP POST message with content-type as "application/json",
    ...
    ///    :ref:`ProcessingResponse <envoy_v3_api_msg_service.ext_proc.v3.ProcessingResponse>`.
    ///
    /// 1. It converts the `ProcessingResponse` proto message into a JSON text.
    ///
    /// 1. It then sends an HTTP response back to the data plane with status code as `"200"`,
    ...
    ///
    /// 1. The gRPC stream is closed prematurely with an error.
    ///
    /// 1. The external processing timeouts.
    ///
    /// 1. The ext_proc server sends back spurious response messages.
    ///
    ...
    pub max_message_timeout: ::core::option::Option<::prost_types::Duration>,
    ...
    pub filter_metadata: ::core::option::Option<::prost_types::Struct>,
    ///
    ...
    pub deferred_close_timeout: ::core::option::Option<::prost_types::Duration>,
...
pub struct ExtProcHttpService {
    ...
    #[prost(message, optional, tag = "1")]
    pub http_service:
        ::core::option::Option<super::super::super::super::super::config::core::v3::HttpService>,
}
...
pub struct MetadataOptions {
    ...
    #[prost(message, optional, tag = "1")]
    pub forwarding_namespaces: ::core::option::Option<metadata_options::MetadataNamespaces>,
    ...
    pub receiving_namespaces: ::core::option::Option<metadata_options::MetadataNamespaces>,
    ...
    #[prost(message, optional, tag = "3")]
    pub cluster_metadata_forwarding_namespaces:
        ::core::option::Option<metadata_options::MetadataNamespaces>,
}
...
pub struct ExtProcOverrides {
    ...
    pub grpc_initial_metadata:
        ::prost::alloc::vec::Vec<super::super::super::super::super::config::core::v3::HeaderValue>,
    ///
    ...
    pub failure_mode_allow: ::core::option::Option<bool>,
    ///
    /// Decorator to introduce custom logic that runs after the `ProcessingRequest` is constructed, but
    /// before it is sent to the External Processor. The `ProcessingRequest` may be modified.

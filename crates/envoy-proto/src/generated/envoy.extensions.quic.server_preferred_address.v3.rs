...
pub struct DataSourceServerPreferredAddressConfig {
    ...
    pub ipv4_config:
        ::core::option::Option<data_source_server_preferred_address_config::AddressFamilyConfig>,
...
pub struct FixedServerPreferredAddressConfig {
    ...
    #[prost(message, optional, tag = "3")]
    pub ipv4_config:
        ::core::option::Option<fixed_server_preferred_address_config::AddressFamilyConfig>,

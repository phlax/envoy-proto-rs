...
pub struct QuicProtocolOptions {
    ...
    #[prost(message, optional, tag = "8")]
    pub connection_id_generator_config:
    ...
    #[prost(message, optional, tag = "9")]
    pub server_preferred_address_config:
        ::core::option::Option<super::super::core::v3::TypedExtensionConfig>,
    ...
    pub send_disable_active_migration: ::core::option::Option<bool>,
    ...
    pub connection_debug_visitor_config:
        ::core::option::Option<super::super::core::v3::TypedExtensionConfig>,
    ...
    pub save_cmsg_config: ::prost::alloc::vec::Vec<super::super::core::v3::SocketCmsgHeaders>,
    ...
    pub max_sessions_per_event_loop: ::core::option::Option<u32>,
}
/// \[#next-free-field: 9\]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct UdpListenerConfig {
    ...
    #[prost(message, optional, tag = "8")]
    pub udp_packet_packet_writer_config:
        ::core::option::Option<super::super::core::v3::TypedExtensionConfig>,
}
...
pub struct Listener {
    ...
    pub max_connections_to_accept_per_socket_event: ::core::option::Option<u32>,
...
pub mod listener {
    ...
    pub struct FcdsConfig {
        ...
        #[prost(message, optional, tag = "2")]
        pub config_source: ::core::option::Option<super::super::super::core::v3::ConfigSource>,
    }
    #[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
    #[repr(i32)]
    pub enum DrainType {

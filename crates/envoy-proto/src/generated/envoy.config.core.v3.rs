...
pub mod grpc_service {
    ...
    pub struct EnvoyGrpc {
        ...
        #[prost(message, optional, tag = "4")]
        pub max_receive_message_length: ::core::option::Option<u32>,
    ...
    pub struct GoogleGrpc {
        ...
        /// \[\#not-implemented-hide:\]
        #[prost(message, repeated, tag = "9")]
        pub channel_credentials_plugin: ::prost::alloc::vec::Vec<::prost_types::Any>,
        ...
        pub call_credentials_plugin: ::prost::alloc::vec::Vec<::prost_types::Any>,
...
pub mod health_check {
    ...
    pub struct HttpHealthCheck {
        ...
        #[prost(message, optional, tag = "14")]
        pub response_buffer_size: ::core::option::Option<u64>,
        ...
        pub expected_statuses:
            ::prost::alloc::vec::Vec<super::super::super::super::r#type::v3::Int64Range>,
        ///
...
pub struct QuicProtocolOptions {
    ...
    #[prost(message, optional, tag = "8")]
    pub idle_network_timeout: ::core::option::Option<::prost_types::Duration>,
    ...
    pub max_packet_length: ::core::option::Option<u64>,
    ...
    /// \[\#not-implemented-hide:\]
    #[prost(message, optional, tag = "11")]
    pub connection_migration:
        ::core::option::Option<quic_protocol_options::ConnectionMigrationSettings>,
    ...
    #[prost(message, optional, tag = "12")]
    pub memory_reduction_timeout: ::core::option::Option<::prost_types::Duration>,
    ...
    pub enable_scone: ::core::option::Option<bool>,
}
...
pub mod quic_protocol_options {
    ...
    pub struct ConnectionMigrationSettings {
        ...
        /// migration signals.
        #[prost(message, optional, tag = "1")]
        pub migrate_idle_connections:
            ::core::option::Option<connection_migration_settings::MigrateIdleConnectionSettings>,
        ...
        /// Default to 128s.
        #[prost(message, optional, tag = "2")]
        pub max_time_on_non_default_network: ::core::option::Option<::prost_types::Duration>,
    }
    ...
    pub mod connection_migration_settings {
        ...
        pub struct MigrateIdleConnectionSettings {
            ...
            /// Default to 30s.
            #[prost(message, optional, tag = "1")]
            pub max_idle_time_before_migration: ::core::option::Option<::prost_types::Duration>,
        }
    }
}
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
pub struct HttpProtocolOptions {
    ...
    #[prost(message, optional, tag = "7")]
    pub max_response_headers_kb: ::core::option::Option<u32>,
...
pub struct Http1ProtocolOptions {
    ...
    #[deprecated]
    #[prost(message, optional, tag = "9")]
    pub use_balsa_parser: ::core::option::Option<bool>,
    ...
    #[prost(message, repeated, tag = "11")]
    pub ignore_http_11_upgrade:
        ::prost::alloc::vec::Vec<super::super::super::r#type::matcher::v3::StringMatcher>,
}
...
pub struct Http2ProtocolOptions {
    ...
    pub enable_huffman_encoding: ::core::option::Option<bool>,
    ...
    pub max_header_field_size_kb: ::core::option::Option<u32>,
    ...
    /// obs-text = %x80-FF
    #[prost(message, optional, tag = "20")]
    pub disallow_obs_text: ::core::option::Option<bool>,
}

...
pub struct FileSystemHttpCacheV2Config {
    ...
    pub max_cache_size_bytes: ::core::option::Option<u64>,
    ...
    pub max_individual_cache_entry_size_bytes: ::core::option::Option<u64>,
    /// The maximum number of cache entries - when reached, cache eviction is triggered.
    ///
    /// If unset there is no limit.
    #[prost(message, optional, tag = "5")]
    pub max_cache_entry_count: ::core::option::Option<u64>,
    ...
    pub max_eviction_period: ::core::option::Option<::prost_types::Duration>,
    ...
    pub min_eviction_period: ::core::option::Option<::prost_types::Duration>,

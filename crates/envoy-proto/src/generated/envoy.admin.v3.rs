...
pub struct ClusterStatus {
    ...
    ///
    #[prost(message, optional, tag = "5")]
    pub local_origin_success_rate_ejection_threshold:
        ::core::option::Option<super::super::r#type::v3::Percent>,
    /// :ref:`Circuit breaking <arch_overview_circuit_break>` settings of the cluster.
    #[prost(message, optional, tag = "6")]
    pub circuit_breakers:
        ::core::option::Option<super::super::config::cluster::v3::CircuitBreakers>,
...
pub struct HostHealthStatus {
    ...
    #[prost(
        enumeration = "super::super::config::core::v3::HealthStatus",
        tag = "3"
    )]
...
pub struct UpdateFailureState {
    ...
    #[prost(message, optional, tag = "1")]
    pub failed_configuration: ::core::option::Option<::prost_types::Any>,
    /// Time of the latest failed update attempt.
    #[prost(message, optional, tag = "2")]
    pub last_update_attempt: ::core::option::Option<::prost_types::Timestamp>,
...
pub mod listeners_config_dump {
    ...
    pub struct StaticListener {
        /// The listener config.
        #[prost(message, optional, tag = "1")]
        pub listener: ::core::option::Option<::prost_types::Any>,
...
pub mod clusters_config_dump {
    ...
    pub struct StaticCluster {
        /// The cluster config.
        #[prost(message, optional, tag = "1")]
        pub cluster: ::core::option::Option<::prost_types::Any>,
...
pub mod routes_config_dump {
    ...
    pub struct StaticRouteConfig {
        /// The route config.
        #[prost(message, optional, tag = "1")]
        pub route_config: ::core::option::Option<::prost_types::Any>,
...
pub struct ScopedRoutesConfigDump {
    ...
    pub inline_scoped_route_configs:
        ::prost::alloc::vec::Vec<scoped_routes_config_dump::InlineScopedRouteConfigs>,
    /// The dynamically loaded scoped route configs.
    #[prost(message, repeated, tag = "2")]
    pub dynamic_scoped_route_configs:
        ::prost::alloc::vec::Vec<scoped_routes_config_dump::DynamicScopedRouteConfigs>,
}
...
pub mod scoped_routes_config_dump {
    ...
    pub struct InlineScopedRouteConfigs {
        ...
        #[prost(message, repeated, tag = "2")]
        pub scoped_route_configs: ::prost::alloc::vec::Vec<::prost_types::Any>,
...
pub struct EndpointsConfigDump {
    ...
    pub static_endpoint_configs:
        ::prost::alloc::vec::Vec<endpoints_config_dump::StaticEndpointConfig>,
    /// The dynamically loaded endpoint configs.
    #[prost(message, repeated, tag = "3")]
    pub dynamic_endpoint_configs:
        ::prost::alloc::vec::Vec<endpoints_config_dump::DynamicEndpointConfig>,
}
...
pub mod endpoints_config_dump {
    ...
    pub struct StaticEndpointConfig {
        /// The endpoint config.
        #[prost(message, optional, tag = "1")]
        pub endpoint_config: ::core::option::Option<::prost_types::Any>,
...
pub mod ecds_config_dump {
    ...
    pub struct EcdsFilterConfig {
        ...
        #[prost(message, optional, tag = "2")]
        pub ecds_filter: ::core::option::Option<::prost_types::Any>,
...
pub struct ConfigDump {
    ...
    #[prost(message, repeated, tag = "1")]
    pub configs: ::prost::alloc::vec::Vec<::prost_types::Any>,
}
...
pub mod secrets_config_dump {
    ...
    pub struct DynamicSecret {
        ...
        #[prost(message, optional, tag = "4")]
        pub secret: ::core::option::Option<::prost_types::Any>,
        /// Set if the last update failed, cleared after the next successful update.
        /// The *error_state* field contains the rejected version of this particular
        /// resource along with the reason and timestamp. For successfully updated or
        /// acknowledged resource, this field should be empty.
...
pub struct ListenerStatus {
    ...
    /// configuration.
    #[prost(message, repeated, tag = "3")]
    pub additional_local_addresses:
        ::prost::alloc::vec::Vec<super::super::config::core::v3::Address>,
}
...
pub struct ServerInfo {
    ...
    #[prost(message, optional, tag = "3")]
    pub uptime_current_epoch: ::core::option::Option<::prost_types::Duration>,
    /// Uptime since the start of the first epoch.
    #[prost(message, optional, tag = "4")]
    pub uptime_all_epochs: ::core::option::Option<::prost_types::Duration>,
    /// Hot restart version.
    #[prost(string, tag = "5")]
...
pub struct CommandLineOptions {
    ...
    pub file_flush_interval: ::core::option::Option<::prost_types::Duration>,
    /// See :option:`--file-flush-min-size-kb` for details.
    #[prost(uint32, tag = "42")]
    pub file_flush_min_size: u32,
    /// See :option:`--drain-time-s` for details.
    #[prost(message, optional, tag = "17")]
    pub drain_time: ::core::option::Option<::prost_types::Duration>,
    ...
    pub parent_shutdown_time: ::core::option::Option<::prost_types::Duration>,

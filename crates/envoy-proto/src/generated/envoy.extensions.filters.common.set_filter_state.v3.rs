...
pub struct FilterStateValue {
    ...
    /// provided value. This field is required when :ref:`object_key  <envoy_v3_api_field_extensions.filters.common.set_filter_state.v3.FilterStateValue.object_key>`
...
pub mod filter_state_value {
    ...
    pub enum Key {
        ...
        /// object. In this case, :ref:`factory_key  <envoy_v3_api_field_extensions.filters.common.set_filter_state.v3.FilterStateValue.factory_key>`
        /// is not needed.
        ///
        ///
        /// When using a custom key name which is not from the well-known list, you must also specify
        /// : ref:`factory_key  <envoy_v3_api_field_extensions.filters.common.set_filter_state.v3.FilterStateValue.factory_key>`

...
pub struct GrpcFieldExtractionConfig {
    ...
    pub extractions_by_method:
        ::std::collections::HashMap<::prost::alloc::string::String, FieldExtractions>,
}
...
pub struct FieldExtractions {
    ...
    pub request_field_extractions:
        ::std::collections::HashMap<::prost::alloc::string::String, RequestFieldValueDisposition>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct RequestFieldValueDisposition {
    #[prost(oneof = "request_field_value_disposition::Disposition", tags = "1")]
    pub disposition: ::core::option::Option<request_field_value_disposition::Disposition>,
}

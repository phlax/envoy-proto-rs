...
pub mod tls_parameters {
    ...
    pub enum CompliancePolicy {
        ...
        ///
        /// * TLS 1.2 or 1.3
        /// * For TLS 1.2, only ECDHE\_\[RSA|ECDSA\]*WITH_AES**\_GCM_SHA*.
...
pub struct TlsCertificate {
    ...
    pub watched_directory:
        ::core::option::Option<super::super::super::super::config::core::v3::WatchedDirectory>,
    ///
    ...
    pub signed_certificate_timestamp:
        ::prost::alloc::vec::Vec<super::super::super::super::config::core::v3::DataSource>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct SubjectAltNameMatcher {
    ...
    #[prost(message, optional, tag = "2")]
    pub matcher:
        ::core::option::Option<super::super::super::super::r#type::matcher::v3::StringMatcher>,
...
pub struct CertificateValidationContext {
    ...
    pub system_root_certs: ::core::option::Option<certificate_validation_context::SystemRootCerts>,
    ...
    pub match_subject_alt_names:
        ::prost::alloc::vec::Vec<super::super::super::super::r#type::matcher::v3::StringMatcher>,
    /// \[\#not-implemented-hide:\] Must present signed certificate time-stamp.
    #[prost(message, optional, tag = "6")]
    pub require_signed_certificate_timestamp: ::core::option::Option<bool>,
    ///
    ...
    pub custom_validator_config:
        ::core::option::Option<super::super::super::super::config::core::v3::TypedExtensionConfig>,
    ...
    pub max_verify_depth: ::core::option::Option<u32>,
}
...
pub struct SdsSecretConfig {
    ...
    #[prost(message, optional, tag = "2")]
    pub sds_config:
        ::core::option::Option<super::super::super::super::config::core::v3::ConfigSource>,
}
/// \[\#next-free-field: 6\]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Secret {
...
pub struct UpstreamTlsContext {
    ...
    #[prost(message, optional, tag = "4")]
    pub max_session_keys: ::core::option::Option<u32>,
    ...
    pub enforce_rsa_key_usage: ::core::option::Option<bool>,
}
/// \[\#next-free-field: 12\]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct DownstreamTlsContext {
    ...
    /// \[\#not-implemented-hide:\]
    #[prost(message, optional, tag = "3")]
    pub require_sni: ::core::option::Option<bool>,
    ...
    #[prost(message, optional, tag = "6")]
    pub session_timeout: ::core::option::Option<::prost_types::Duration>,
    ...
    pub full_scan_certs_on_sni_mismatch: ::core::option::Option<bool>,
    ...
    #[prost(
        oneof = "downstream_tls_context::SessionTicketKeysType",
        tags = "4, 5, 7"
    )]
    pub session_ticket_keys_type:
        ::core::option::Option<downstream_tls_context::SessionTicketKeysType>,
}
...
pub struct TlsKeyLog {
    ...
    pub local_address_range:
        ::prost::alloc::vec::Vec<super::super::super::super::config::core::v3::CidrRange>,
    /// Remote IP address ranges to filter connections for TLS key logging. If not set, matches any remote IP address.
    #[prost(message, repeated, tag = "3")]
    pub remote_address_range:
        ::prost::alloc::vec::Vec<super::super::super::super::config::core::v3::CidrRange>,
}
...
pub struct CommonTlsContext {
    ...
    pub tls_certificate_provider_instance:
        ::core::option::Option<CertificateProviderPluginInstance>,
    ...
    #[prost(message, optional, tag = "16")]
    pub custom_tls_certificate_selector:
        ::core::option::Option<super::super::super::super::config::core::v3::TypedExtensionConfig>,
    /// Certificate provider for fetching TLS certificates.
    /// \[\#not-implemented-hide:\]
    #[deprecated]
    #[prost(message, optional, tag = "9")]
    pub tls_certificate_certificate_provider:
        ::core::option::Option<common_tls_context::CertificateProvider>,
    /// Certificate provider instance for fetching TLS certificates.
    /// \[\#not-implemented-hide:\]
    #[deprecated]
    #[prost(message, optional, tag = "11")]
    pub tls_certificate_certificate_provider_instance:
        ::core::option::Option<common_tls_context::CertificateProviderInstance>,
    ///
...
pub mod common_tls_context {
    ...
    pub struct CombinedCertificateValidationContext {
        ...
        #[deprecated]
        #[prost(message, optional, tag = "4")]
        pub validation_context_certificate_provider_instance:
            ::core::option::Option<CertificateProviderInstance>,
    }
    #[derive(Clone, PartialEq, ::prost::Oneof)]

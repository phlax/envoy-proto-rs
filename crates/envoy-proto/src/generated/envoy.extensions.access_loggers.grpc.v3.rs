...
pub struct CommonGrpcAccessLogConfig {
    ...
    pub grpc_service:
        ::core::option::Option<super::super::super::super::config::core::v3::GrpcService>,
    ...
    pub buffer_flush_interval: ::core::option::Option<::prost_types::Duration>,
    /// Soft size limit in bytes for access log entries buffer. Logger will buffer requests until
    /// this limit it hit, or every time flush interval is elapsed, whichever comes first. Setting it
    /// to zero effectively disables the batching. Defaults to 16384.
    #[prost(message, optional, tag = "4")]
    pub buffer_size_bytes: ::core::option::Option<u32>,
    ...
    pub grpc_stream_retry_policy:
        ::core::option::Option<super::super::super::super::config::core::v3::RetryPolicy>,
    /// A list of custom tags with unique tag name to create tags for the logs.
    #[prost(message, repeated, tag = "8")]
    pub custom_tags:
        ::prost::alloc::vec::Vec<super::super::super::super::r#type::tracing::v3::CustomTag>,
}

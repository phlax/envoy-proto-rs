...
pub struct RedisProxy {
    ...
    pub downstream_auth_passwords:
        ::prost::alloc::vec::Vec<super::super::super::super::super::config::core::v3::DataSource>,
...
pub mod redis_proxy {
    ...
    pub struct ConnPoolSettings {
        ...
        pub op_timeout: ::core::option::Option<::prost_types::Duration>,
        ...
        /// defaults to 3ms.
        #[prost(message, optional, tag = "5")]
        pub buffer_flush_timeout: ::core::option::Option<::prost_types::Duration>,
        ...
        #[prost(message, optional, tag = "6")]
        pub max_upstream_unknown_connections: ::core::option::Option<u32>,
    ...
    pub mod conn_pool_settings {
        ...
        pub enum ReadPolicy {
            ...
            LocalZoneAffinityReplicasAndPrimary = 6,
        }
        impl ReadPolicy {
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    ...
                    Self::Any => "ANY",
                    Self::LocalZoneAffinity => "LOCAL_ZONE_AFFINITY",
                    Self::LocalZoneAffinityReplicasAndPrimary => {
            ...
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
                match value {
                    ...
                    "ANY" => Some(Self::Any),
                    "LOCAL_ZONE_AFFINITY" => Some(Self::LocalZoneAffinity),
                    "LOCAL_ZONE_AFFINITY_REPLICAS_AND_PRIMARY" => {
                        Some(Self::LocalZoneAffinityReplicasAndPrimary)
                    }
                    _ => None,
                }
            }
...
pub struct AwsIam {
    ...
    pub credential_provider:
        ::core::option::Option<super::super::super::super::common::aws::v3::AwsCredentialProvider>,
    ...
    #[prost(message, optional, tag = "5")]
    pub expiration_time: ::core::option::Option<::prost_types::Duration>,
}

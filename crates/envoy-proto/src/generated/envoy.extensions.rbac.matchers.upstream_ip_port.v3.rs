...
pub struct UpstreamIpPortMatcher {
    ...
    pub upstream_ip:
        ::core::option::Option<super::super::super::super::super::config::core::v3::CidrRange>,
    /// A port range that will be used to match the upstream port.
    #[prost(message, optional, tag = "2")]
    pub upstream_port_range:
        ::core::option::Option<super::super::super::super::super::r#type::v3::Int64Range>,
}

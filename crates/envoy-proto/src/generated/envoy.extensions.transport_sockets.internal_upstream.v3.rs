...
pub struct InternalUpstreamTransport {
    ...
    pub passthrough_metadata:
        ::prost::alloc::vec::Vec<internal_upstream_transport::MetadataValueSource>,
    /// The underlying transport socket being wrapped.
    #[prost(message, optional, tag = "3")]
    pub transport_socket:
        ::core::option::Option<super::super::super::super::config::core::v3::TransportSocket>,
}
